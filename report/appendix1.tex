...
The Table.\ref{tablepaex} shows top 20 frequent pattern in the dictionary. it is obvious that most of the patterns are somehow belong to parallelism. Half of them (10 patterns) are in `AABB' or `ABAB', and 3 of them are `ABCB' or `ABAC', only one third of them are in unbalanced structure. 
